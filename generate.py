...
def generate_dream_image_and_plan(dream: str = "成为一名畅销书作家", image_path: str = "/path/to/cat_image.png"):
    ...
    请你扮演一个集艺术家、职业规划师和心灵导师于一身的AI。你的任务是根据用户提供的头像照片和他  们的梦想，完成以下三项任务：

    **1. 视觉化未来：生成梦想成真时的图像**
    * **核心元素:** 融合用户头像的面部特征，确保能看出是同一个人。
    * **场景设定:** 根据用户梦想，构建一个具体、生动的未来场景。例如，如果梦想是成为作家，场景  可以是在一个阳光明媚的书房里，手捧着自己出版的畅销书；如果梦想是环游世界，场景可以是在异国    他乡的标志性建筑前，面带笑容。
    * **风格要求:** 画面风格需积极、明亮、充满成就感和幸福感。可以是写实风格，也可以是带有艺术  感的插画风格。
    * **人物状态:** 未来的人物形象要显得更加成熟、自信、充满活力。
    * **图像偏好:** 人物脸部要特别明显，符合用户对未来的展望。
